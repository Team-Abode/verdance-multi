...
public class SilkMothModel extends HierarchicalModel<SilkMoth> {
	...
	public void setupAnim(SilkMoth entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		float deltaTicks = ageInTicks - entity.lastAnimationProgress;
		entity.lastAnimationProgress = ageInTicks;
	...
	private void animateBones(SilkMoth entity, float animationProgress, float deltaTicks, float netHeadYaw, float headPitch) {
