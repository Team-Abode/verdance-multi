...
public class VerdanceSensorTypes {
    ...
    public static <T extends Sensor<?>> Supplier<SensorType<T>> register(String name, Supplier<T> sensorType) {
        return Services.REGISTRY.registerSensorType(name, () -> new SensorType<>(sensorType));
    }
